...
[Serializable]
public class ImageFormatEnum : DynamicEnumBase<ImageFormatEnum, ImageFormatEnumDefinition>
{
    public ImageFormatEnum(string value) : base(value)
    {
    }

    [CreateDefault]
    public static ImageFormatEnum CreateDefault()
    {
        return CreateDefaultBase();
    }
}

public class ImageFormatEnumDefinition : DynamicEnumDefinitionBase<ImageFormatEnumDefinition>
{
    Dictionary<string, object> entries = new Dictionary<string, object>();
    Subject<object> trigger = new Subject<object>(); //Really just used as a trigger, the "object" is ignored

    [CreateDefault]
    public static ImageFormatEnumDefinition CreateDefault()
    {
        return Instance;
    }
